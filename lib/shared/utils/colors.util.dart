...
class ColorsUtil {
  ...
  static const Color primary = Color.fromRGBO(83, 109, 254, 1);
  static const Color secondary = Color.fromRGBO(240, 98, 146, 1);

  static const Color error = Color.fromRGBO(238, 5, 94, 1.0);
  static const Color warning = Color.fromRGBO(255, 191, 71, 1.0);
  static const Color success = Color.fromRGBO(8, 176, 111, 1.0);
