...
mixin _$CountryEntity {
 ...
 String? get name; String? get isoCode; String? get dialCode; DateTime? get lastUpdated;
...
@override
int get hashCode => Object.hash(runtimeType,name,isoCode,dialCode,lastUpdated);

@override
String toString() {
  return 'CountryEntity(name: $name, isoCode: $isoCode, dialCode: $dialCode, lastUpdated: $lastUpdated)';
}
...
@useResult
$Res call({
 String? name, String? isoCode, String? dialCode, DateTime? lastUpdated
});
...
/// Create a copy of CountryEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? isoCode = freezed,Object? dialCode = freezed,Object? lastUpdated = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? name,  String? isoCode,  String? dialCode,  DateTime? lastUpdated)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CountryEntity() when $default != null:
return $default(_that.name,_that.isoCode,_that.dialCode,_that.lastUpdated);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String? isoCode,  String? dialCode,  DateTime? lastUpdated)  $default,) {final _that = this;
switch (_that) {
case _CountryEntity():
return $default(_that.name,_that.isoCode,_that.dialCode,_that.lastUpdated);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String? isoCode,  String? dialCode,  DateTime? lastUpdated)?  $default,) {final _that = this;
switch (_that) {
case _CountryEntity() when $default != null:
return $default(_that.name,_that.isoCode,_that.dialCode,_that.lastUpdated);case _:
  return null;
...
class _CountryEntity implements CountryEntity {
  const _CountryEntity({required this.name, required this.isoCode, required this.dialCode, required this.lastUpdated});
...
/// Create a copy of CountryEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? isoCode = freezed,Object? dialCode = freezed,Object? lastUpdated = freezed,}) {
