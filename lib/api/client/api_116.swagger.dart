...
- NotFoundException (404): No valid OTP found for the admin user.''',
  ...
  ///Sign out the authenticated admin user
  @DELETE(path: '/api/v1/admin/auth/sign-out')
...
8. Returns success response.''',
  ...
  Future<chopper.Response<AdminGetOwnProfileResponse>> GetAdminOwnProfile() {
    generatedMapping.putIfAbsent(
      AdminGetOwnProfileResponse,
      () => AdminGetOwnProfileResponse.fromJsonFactory,
    );

    return _GetAdminOwnProfile();
  }

  ///Retrieve authenticated admin user's complete profile information
  @GET(path: '/api/v1/admin/profile')
  Future<chopper.Response<AdminGetOwnProfileResponse>> _GetAdminOwnProfile({
    @chopper.Tag()
    SwaggerMetaData swaggerMetaData = const SwaggerMetaData(
      description:
...
6. Returns comprehensive admin user profile information''',
      summary:
          'Retrieve authenticated admin user\'s complete profile information',
      operationId: 'GetAdminOwnProfile',
      consumes: [],
      produces: [],
      security: [],
      tags: ["admin::profile"],
...
6. Returns updated admin user information with avatar details''',
  ...
  Future<chopper.Response<PublicVerifyOtpResponse>> VerifyOtp({
    ...
    return _VerifyOtp(body: body);
  }

  ///Verify OTP code for account activation
  @POST(path: '/api/v1/public/auth/verify-otp', optionalBody: true)
  Future<chopper.Response<PublicVerifyOtpResponse>> _VerifyOtp({
...
- ConflictException (409): User account is already verified.''',
  ...
  Future<chopper.Response<PublicSocialLoginResponse>> SocialLogin({
    required PublicSocialLoginRequest? body,
  }) {
    generatedMapping.putIfAbsent(
      PublicSocialLoginResponse,
      () => PublicSocialLoginResponse.fromJsonFactory,
    );

    return _SocialLogin(body: body);
  }

  ///Authenticate user via social provider
  @POST(path: '/api/v1/public/auth/social-login', optionalBody: true)
  Future<chopper.Response<PublicSocialLoginResponse>> _SocialLogin({
...
- ConflictException (409): Local account already exists with email.''',
  ...
  Future<chopper.Response<PublicSignUpResponse>> _PublicSignUp({
...
- ConflictException (409): Email or username already in use.''',
  ...
  Future<chopper.Response<PublicSignOutResponse>> SignOut() {
    generatedMapping.putIfAbsent(
  ...
  ///Sign out the authenticated user
  @DELETE(path: '/api/v1/public/auth/sign-out')
  Future<chopper.Response<PublicSignOutResponse>> _SignOut({
    @chopper.Tag()
    SwaggerMetaData swaggerMetaData = const SwaggerMetaData(
      description:
...
4. Returns success response.''',
  ...
  Future<chopper.Response<PublicResetPasswordResponse>> ResetPassword({
    ...
    return _ResetPassword(body: body);
  }

  ///Reset user password using OTP verification
  @POST(path: '/api/v1/public/auth/reset-password', optionalBody: true)
  Future<chopper.Response<PublicResetPasswordResponse>> _ResetPassword({
...
- AccountRecovery: For account recovery processes''',
  ...
  Future<chopper.Response<PublicLoginResponse>> _PublicLogin({
...
- NotFoundException (404): User not found - no account exists with the provided email/userName.''',
  ...
  Future<chopper.Response<PublicForgotPasswordResponse>> ForgotPassword({
    ...
    return _ForgotPassword(body: body);
  }

  ///Initiate password reset process for existing users
  @POST(path: '/api/v1/public/auth/forgot-password', optionalBody: true)
  Future<chopper.Response<PublicForgotPasswordResponse>> _ForgotPassword({
...
4. Returns success response (regardless of actual outcome).''',
  ...
  Future<chopper.Response<PublicChangePasswordResponse>> ChangePassword({
    ...
    return _ChangePassword(body: body);
  }

  ///Change user password with current password verification
  @PATCH(path: '/api/v1/public/auth/change-password', optionalBody: true)
  Future<chopper.Response<PublicChangePasswordResponse>> _ChangePassword({
...
8. Returns success response.''',
  ...
  Future<chopper.Response<PublicGetOwnProfileResponse>> GetOwnProfile() {
    generatedMapping.putIfAbsent(
      PublicGetOwnProfileResponse,
      () => PublicGetOwnProfileResponse.fromJsonFactory,
    );

    return _GetOwnProfile();
  }

  ///Retrieve authenticated user's complete profile information
  @GET(path: '/api/v1/public/profile')
  Future<chopper.Response<PublicGetOwnProfileResponse>> _GetOwnProfile({
    @chopper.Tag()
    SwaggerMetaData swaggerMetaData = const SwaggerMetaData(
      description:
...
6. Returns comprehensive user profile information.''',
  ...
  Future<chopper.Response<PublicUpdateOwnProfileResponse>> UpdateOwnProfile({
    ...
    return _UpdateOwnProfile(body: body);
  }

  ///Update authenticated user's own profile information
  @PATCH(path: '/api/v1/public/profile', optionalBody: true)
  Future<chopper.Response<PublicUpdateOwnProfileResponse>> _UpdateOwnProfile({
