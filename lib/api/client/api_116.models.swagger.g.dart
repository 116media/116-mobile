...
AdminChangePasswordRequest _$AdminChangePasswordRequestFromJson(Map<String, dynamic> json) =>
    AdminChangePasswordRequest(
      oldPassword: json['oldPassword'] as String,
      newPassword: json['newPassword'] as String,
    );

Map<String, dynamic> _$AdminChangePasswordRequestToJson(AdminChangePasswordRequest instance) =>
    <String, dynamic>{'oldPassword': instance.oldPassword, 'newPassword': instance.newPassword};

AdminChangePasswordResponse _$AdminChangePasswordResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdminForgotPasswordRequestToJson(AdminForgotPasswordRequest instance) =>
    <String, dynamic>{'email': instance.email};

AdminForgotPasswordResponse _$AdminForgotPasswordResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdminLoginRequestToJson(AdminLoginRequest instance) => <String, dynamic>{
...
AdminResendOtpRequest _$AdminResendOtpRequestFromJson(Map<String, dynamic> json) =>
    AdminResendOtpRequest(email: json['email'] as String, purpose: json['purpose'] as String);

Map<String, dynamic> _$AdminResendOtpRequestToJson(AdminResendOtpRequest instance) =>
    <String, dynamic>{'email': instance.email, 'purpose': instance.purpose};

AdminResendOtpResponse _$AdminResendOtpResponseFromJson(Map<String, dynamic> json) =>
    AdminResendOtpResponse(isSuccess: json['isSuccess'] as bool);

Map<String, dynamic> _$AdminResendOtpResponseToJson(AdminResendOtpResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess};

AdminResetPasswordRequest _$AdminResetPasswordRequestFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdminResetPasswordRequestToJson(AdminResetPasswordRequest instance) =>
    <String, dynamic>{
      'email': instance.email,
      'code': instance.code,
...
AdminResetPasswordResponse _$AdminResetPasswordResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdminSignOutResponseToJson(AdminSignOutResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess};

AdminUpdateAvatarResponse _$AdminUpdateAvatarResponseFromJson(Map<String, dynamic> json) =>
    AdminUpdateAvatarResponse(user: UserResponseDto.fromJson(json['user'] as Map<String, dynamic>));

Map<String, dynamic> _$AdminUpdateAvatarResponseToJson(AdminUpdateAvatarResponse instance) =>
    <String, dynamic>{'user': instance.user.toJson()};

AdminUpdateOwnProfileRequest _$AdminUpdateOwnProfileRequestFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdminUpdateOwnProfileRequestToJson(AdminUpdateOwnProfileRequest instance) =>
    <String, dynamic>{
...
AdminUpdateOwnProfileResponse _$AdminUpdateOwnProfileResponseFromJson(Map<String, dynamic> json) =>
...
AdminVerifyOtpRequest _$AdminVerifyOtpRequestFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdminVerifyOtpRequestToJson(AdminVerifyOtpRequest instance) =>
    <String, dynamic>{'email': instance.email, 'code': instance.code, 'purpose': instance.purpose};

AdminVerifyOtpResponse _$AdminVerifyOtpResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PermissionDtoToJson(PermissionDto instance) => <String, dynamic>{
  'id': instance.id,
...
PublicChangePasswordRequest _$PublicChangePasswordRequestFromJson(Map<String, dynamic> json) =>
    PublicChangePasswordRequest(
      oldPassword: json['oldPassword'] as String,
      newPassword: json['newPassword'] as String,
    );

Map<String, dynamic> _$PublicChangePasswordRequestToJson(PublicChangePasswordRequest instance) =>
    <String, dynamic>{'oldPassword': instance.oldPassword, 'newPassword': instance.newPassword};

PublicChangePasswordResponse _$PublicChangePasswordResponseFromJson(Map<String, dynamic> json) =>
    PublicChangePasswordResponse(isSuccess: json['isSuccess'] as bool);

Map<String, dynamic> _$PublicChangePasswordResponseToJson(PublicChangePasswordResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess};

PublicForgotPasswordRequest _$PublicForgotPasswordRequestFromJson(Map<String, dynamic> json) =>
    PublicForgotPasswordRequest(email: json['email'] as String);

Map<String, dynamic> _$PublicForgotPasswordRequestToJson(PublicForgotPasswordRequest instance) =>
    <String, dynamic>{'email': instance.email};

PublicForgotPasswordResponse _$PublicForgotPasswordResponseFromJson(Map<String, dynamic> json) =>
    PublicForgotPasswordResponse(
      isSuccess: json['isSuccess'] as bool,
      email: json['email'] as String,
    );

Map<String, dynamic> _$PublicForgotPasswordResponseToJson(PublicForgotPasswordResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess, 'email': instance.email};

PublicGetOwnProfileResponse _$PublicGetOwnProfileResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PublicLoginRequestToJson(PublicLoginRequest instance) => <String, dynamic>{
...
Map<String, dynamic> _$PublicResendOtpRequestToJson(PublicResendOtpRequest instance) =>
    <String, dynamic>{'email': instance.email, 'purpose': instance.purpose};

PublicResendOtpResponse _$PublicResendOtpResponseFromJson(Map<String, dynamic> json) =>
    PublicResendOtpResponse(isSuccess: json['isSuccess'] as bool);

Map<String, dynamic> _$PublicResendOtpResponseToJson(PublicResendOtpResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess};

PublicResetPasswordRequest _$PublicResetPasswordRequestFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PublicResetPasswordRequestToJson(PublicResetPasswordRequest instance) =>
    <String, dynamic>{
      'email': instance.email,
      'code': instance.code,
      'newPassword': instance.newPassword,
...
PublicResetPasswordResponse _$PublicResetPasswordResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PublicSignOutResponseToJson(PublicSignOutResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess};

PublicSignUpRequest _$PublicSignUpRequestFromJson(Map<String, dynamic> json) => PublicSignUpRequest(
  email: json['email'] as String,
  userName: json['userName'] as String,
  password: json['password'] as String,
);

Map<String, dynamic> _$PublicSignUpRequestToJson(PublicSignUpRequest instance) => <String, dynamic>{
  'email': instance.email,
  'userName': instance.userName,
  'password': instance.password,
};
...
PublicSocialLoginRequest _$PublicSocialLoginRequestFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PublicSocialLoginRequestToJson(PublicSocialLoginRequest instance) =>
    <String, dynamic>{
      'email': instance.email,
      'userName': instance.userName,
...
Map<String, dynamic> _$PublicUpdateAvatarResponseToJson(PublicUpdateAvatarResponse instance) =>
    <String, dynamic>{'user': instance.user.toJson()};

PublicUpdateOwnProfileRequest _$PublicUpdateOwnProfileRequestFromJson(Map<String, dynamic> json) =>
...
PublicVerifyOtpRequest _$PublicVerifyOtpRequestFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PublicVerifyOtpRequestToJson(PublicVerifyOtpRequest instance) =>
    <String, dynamic>{'email': instance.email, 'code': instance.code, 'purpose': instance.purpose};

PublicVerifyOtpResponse _$PublicVerifyOtpResponseFromJson(Map<String, dynamic> json) =>
    PublicVerifyOtpResponse(isSuccess: json['isSuccess'] as bool);

Map<String, dynamic> _$PublicVerifyOtpResponseToJson(PublicVerifyOtpResponse instance) =>
    <String, dynamic>{'isSuccess': instance.isSuccess};
