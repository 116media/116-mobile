...
SessionDto _$SessionDtoFromJson(Map<String, dynamic> json) => SessionDto(
  ...
  browser: enumBrowserFromJson(json['browser']),
  device: enumDeviceFromJson(json['device']),
  platform: enumPlatformFromJson(json['platform']),
  $client: enumClientFromJson(json['client']),
...
Map<String, dynamic> _$SessionDtoToJson(SessionDto instance) =>
    <String, dynamic>{
      ...
      'browser': enumBrowserToJson(instance.browser),
      'device': enumDeviceToJson(instance.device),
      'platform': enumPlatformToJson(instance.platform),
      'client': enumClientToJson(instance.$client),
